...
const Coupons = () => {
  ...
  return (
    <DashboardLayout title="Coupon Codes" subtitle="Create and manage discount coupons for your shop products">
      <Card className="mb-6">
        <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4">
              <h3 className="font-medium text-gray-900 mb-2">Coupon Performance</h3>
              <div className="space-y-2">
                {coupons
                  .sort((a, b) => b.usageCount - a.usageCount)
                  .map((coupon, index) => index < 3 ? (
