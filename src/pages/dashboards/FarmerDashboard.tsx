...
const FarmerDashboard = () => {
  ...
  const farmerProducts = mockProducts.filter(p => p.vendorType === 'farmer');
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Manage your farm products, orders, and customers"
    >
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link to="/farmer/products" className="text-sm text-prisona-600 hover:text-prisona-700 font-medium">
                View All
              </Link>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={product.id} className="border border-gray-200 rounded-lg overflow-hidden flex">
                    ...
                    <div className="w-2/3 p-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-prisona-700 font-medium">${product.price}</span>
              ...
              <div className="mt-6 text-center">
                <Link to="/farmer/products/add" className="bg-prisona-500 text-white py-2 px-4 rounded-md text-sm font-medium hover:bg-prisona-600 inline-block">
                  + Add New Product
                </Link>
              </div>
            </CardContent>
          ...
          <Card className="mt-6">
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link to="/farmer/orders" className="text-sm text-prisona-600 hover:text-prisona-700 font-medium">
                View All
              </Link>
            </CardHeader>
            <CardContent>
                    ...
                    <div key={order.id} className="border border-gray-200 rounded-lg p-4">
                      ...
                      <div className="border-t border-gray-100 pt-2">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          {order.items.filter(item => item.vendorType === 'farmer').length} products from your farm
                        </p>
                      </div>
                      
                      <div className="mt-3 text-right">
                        <Link to={`/farmer/orders/${order.id}`} className="text-sm text-prisona-600 hover:text-prisona-700 font-medium">
                          View Details
                        </Link>
                      </div>
                    </div>
        ...
        <div>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Link to="/farmer/profile" className="text-sm text-prisona-600 hover:text-prisona-700 font-medium">
                Edit
              </Link>
            </CardHeader>
            <CardContent>
          ...
          <Card className="mt-6">
            <CardHeader>
              <CardTitle className="text-xl">Farm Stats</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className="bg-prisona-500 h-2 rounded-full" style={{ width: '80%' }}></div>
                  </div>
                </div>
